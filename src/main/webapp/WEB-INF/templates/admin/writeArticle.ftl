...
<@defaultLayout.htmlBody>
    <div class="content-wrapper">
        ...
        <section class="content">
            <form id="defaultForm" action="/article/write/save" method="post"
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label>标题</label>
                                    <input name="title" type="text" class="form-control" value="未命名">
                                </div>
                                <!-- textarea -->
                                <div >
                                    <!-- editormd start -->
                        ...
                        <div class="box">
                            <div class="box-body" style="margin-top: 50px">
                                ...
                                <div class="form-group" style="margin-left: 40%;">
                                    <label>是否置顶</label>
                                    <input name="isTop_flag" type="checkbox" class="flat-red" >

                                    <label>禁止评论</label>
                                    <input name="isComment_flag" type="checkbox" class="flat-red">
                                </div>
                                <div class="form-group" style="margin-left: 40%">
